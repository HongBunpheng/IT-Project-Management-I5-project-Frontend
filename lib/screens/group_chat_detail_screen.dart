...
class _GroupChatDetailScreenState extends State<GroupChatDetailScreen>
  ...
  void initState() {
    ...
    _groupMessageInputKey =
        GlobalKey(debugLabel: 'groupMessageInput_$instanceId');
        ...
        if (mounted && _scrollController.hasClients) {
          ...
          if (_lastMessage == null ||
            ...
            if (!isPaginating) {
              ...
              final isSentByMe = messages.isNotEmpty &&
    ...
    try {
      ...
      if (blockedMembers.isNotEmpty) {
        ...
        snackBar(
          ...
          message: blockedMembers.length == 1
  ...
  void _handleResponsiveChange() {
    ...
    if (_lastResponsiveChange != null &&
        DateTime.now().difference(_lastResponsiveChange!).inMilliseconds < 100) {
      return;
    }
        ...
        child: Stack(
          children: [
            Scaffold(
              ...
              drawerEnableOpenDragGesture: !(responsive.isDesktop ||
                  responsive.isIPadLandscape ||
                  widget.hideDrawer),
              ...
              appBar: GroupChatHeader(
                ...
                hideDrawer: responsive.isDesktop ||
                    responsive.isIPadLandscape ||
                    widget.hideDrawer,
              ),
                    ...
                    Column(
                      children: [
                        ...
                        RepaintBoundary(
                          child: Obx(() {
                            if (groupController
                                    .loadingMessage.value.isNotEmpty &&
                        ...
                        RepaintBoundary(
                          child: Obx(() {
                            ...
                            if (recordingDataMap != null) {
                              ...
                              final isRecording = isRecordingValue == true ||
                                  isRecordingValue == 1 ||
  ...
  Widget _buildListChat(BuildContext context) {
    ...
    return _StableMessageListWidget(
      ...
      onHandleMessageTap: (message) =>
          _handleMessageTap(message, context, isGroup: true),
      onBuildSearchResultItem: (message, context) =>
          _buildSearchResultItem(message, context),
                    ...
                    children: [
                      Padding(
                        ...
                        child: Container(
                          ...
                          child: ClipOval(
                            child: Image.network(
                              groupController.groupById.value.avatarUrl ?? '',
                              width: responsive.isDesktop ? 80 : 100,
                              height: responsive.isDesktop ? 80 : 100,
                              fit: BoxFit.cover,
                              errorBuilder: (context, error, stackTrace) {
                                final size = responsive.isDesktop ? 80 : 100;
                                return CircleAvatar(
                                  radius: size / 2,
                      ...
                      MixedText(
                        groupController.groupById.value.name,
                        style: TextStyle(
                          fontSize: responsive.isDesktop ? 18 : 20,
                      ...
                      if ((groupController.groupById.value.description)
                          .isNotEmpty)
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              MixedText(
                                groupController.groupById.value.description,
                                style: TextStyle(
                                  fontSize: 14,
                    ...
                    children: [
                      if (groupController.groupById.value.members.any(
                        ...
                        _buildActionButton(
                          ...
                          onTap: () => showMemberSelectionDialog(
                      ...
                      _buildActionButton(
                          ...
                          onTap: () => showAIGroupInsightsBottomSheet(
                                context,
                                groupId: groupController.groupById.value.chatId,
                              )),
                      _buildActionButton(
  ...
  Padding _buildMembersSection(
      BuildContext context, List<GroupByIdMember> allMembers) {
              ...
              children: [
                ...
                Expanded(
                  child: Obx(() {
                    ...
                    final onlineCount = sortedMembers
                        .where((member) =>
                                ...
                                ClipOval(
                                  child: isImageLoading
                                      ...
                                      : (selectedImage != null
                                          ...
                                          : ClipOval(
                                              child: Image.network(
                                                groupController.groupById.value
                                                        .avatarUrl ??
                                                    '',
                                                width: 80,
                                                height: 80,
  ...
  Widget _buildMemberItemWithRemove(
      BuildContext context, GroupByIdMember member) {
    final String currentUserId = authController.user.value.id;
    final responsive = ResponsiveUtils(context);
    // Determine if the current user is an admin
    final bool isCurrentUserAdmin = groupController.groupById.value.members
      ...
      child: Material(
        ...
        child: InkWell(
          ...
          onTap: () async {
            ...
            buildProfileUser(context, userProfileController.userProfile.value,
                hasConnection: hasConnection);
          },
          child: Padding(
                ...
                ClipOval(
                  child: AuthenticatedAvatarWidget(
                    ...
                    errorWidget: _buildInitialsAvatar(
                        member.user.name, responsive.isDesktop ? 32 : 44),
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          if (member.role == 'ADMIN' ||
                              member.userId ==
                                  groupController.groupById.value.creatorId) ...[
                            const SizedBox(width: 8),
                            MixedText(
                              (member.userId ==
                                          groupController.groupById.value.creatorId
                      ...
                      if (member.userId == authController.user.value.id) ...[
                        ...
                        Obx(() {
                          ...
                          return MixedText(
                            ...
                            style: TextStyle(
                              fontSize: 13,
                              color: isOnline ? const Color(0xFF0088CC) : const Color(0xFF8E8E93),
  ...
  Future<void> _showActionsDialog(BuildContext context) {
    ...
    final bool isAdmin = groupController.groupById.value.members.any((member) =>
        member.role == 'ADMIN' &&
        member.userId == authController.user.value.id);
    ...
    return showModalBottomSheet(
      ...
      builder: (context) => GroupActionsBottomSheetContent(
        isAdmin: isAdmin,
        isPrivate: isPrivate,
    ...
    return RepaintBoundary(
      child: AnimatedContainer(
        ...
        child: Obx(() {
          ...
          final currentMessage = groupController.groupMessages
                  .firstWhereOrNull((m) => m.id == messageId) ??
              message;

          // ✅ FIX: Use ID comparison instead of object equality
          final isSelected =
              chatController.selectedMessages.any((m) => m.id == messageId);
  ...
  void _handleMessageTap(MessageModel message, BuildContext context,
      {bool isGroup = false}) {
    if (chatController.isSelectionMode.value) {
      chatController.toggleMessageSelection(message);
    } else {
      showMessageOptions(
          context, message, userProfileController.userProfile.value,
          isGroup: isGroup);
    }
  }
    ...
    while (i < messages.length) {
      ...
      if ((current.type == 'IMAGE' || current.type == 'VIDEO')) {
        ...
        while (j < messages.length) {
          ...
          final timeDiff = (current.scheduledAt ?? current.createdAt)
  ...
  Widget buildSendingMessageIndicator() {
    final label = groupController.loadingMessage.value.isNotEmpty
        ? groupController.loadingMessage.value
        : 'sending_message'.tr;
    return Padding(
  ...
  Widget _buildHeaderSection() {
    return Obx(() {
      ...
      final userPinnedMessages = chatController.pinnedMessagesList
      ...
      return Padding(
        ...
        child: Row(
          ...
          children: [
                ...
                child: _buildHeaderChip(
                  onTap: () {
                    showModalBottomSheet(
                      ...
                      builder: (context) => _PinnedMessageModal(
            ...
            Expanded(
              child: _buildHeaderChip(
                onTap: () async => await GlobalRssService.openRssBottomSheet(
                  context,
              ...
              child: _buildHeaderChip(
                onTap: () {
                  showModalBottomSheet(
                    ...
                    isScrollControlled: true,
                    backgroundColor: Colors.transparent,
                    builder: (sheetContext) => GlobalChecklistModal(
                      conversationId: groupController.groupById.value.chatId,
  ...
  Widget _buildSearchBar() {
    return Obx(() => AnimatedSwitcher(
          ...
          child: groupController.isSearching.value
              ? GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: Row(
                      children: [
                          ...
                          child: TextField(
                            ...
                            contextMenuBuilder: (context, editableTextState) {
                              return const SizedBox
                                  .shrink(); // Return empty widget to hide context menu
                            },
                            onChanged: (query) {
                              ...
                              if (query.trim().isEmpty) {
                                ...
                                groupController.debouncedSearch(
                                    groupController.groupById.value.id, query);
                              }
                            },
                            style: const TextStyle(
                              fontSize: 16,
                        ...
                        Obx(() => groupController.searchQuery.value.isNotEmpty
                            ? AnimatedSwitcher(
                                duration: const Duration(milliseconds: 200),
                                child: IconButton(
                                  ...
                                  onPressed: () {
                                    ...
                                    groupController.isSearchLoading.value =
                                        false;
                                    groupController.searchCurrentPage.value = 1;
                                    groupController.searchHasMoreItems.value =
                                        true;
                                    groupController.searchIsLoadingMore.value =
                                        false;
                                  },
  ...
  Widget _buildSearchResultItem(MessageModel message, BuildContext context) {
    ...
    if (senderName.isEmpty || avatarUrl.isEmpty) {
      ...
      if (senderName.isEmpty) {
        senderName = currentUser.fullname.isNotEmpty
    ...
    Widget _highlightText(String text, String query) {
      ...
      if (query.isEmpty) {
        return MixedText(
          displayText,
          style: FontUtils.createTextStyle(displayText,
      ...
      while ((index = lowerText.indexOf(lowerQuery, start)) != -1) {
        if (index > start) {
          ...
          spans.add(TextSpan(
            text: textSegment,
            style:
                FontUtils.createTextStyle(textSegment, color: Colors.black87),
          ));
        }
        final highlightText =
            displayText.substring(index, index + query.length);
        spans.add(TextSpan(
          text: highlightText,
          style: FontUtils.createTextStyle(
            highlightText,
      ...
      if (start < displayText.length) {
        ...
        spans.add(TextSpan(
          text: remainingText,
          style:
              FontUtils.createTextStyle(remainingText, color: Colors.black87),
        ));
      }
      return RichText(
        text: TextSpan(
                        ...
                        builder: (context, snapshot) {
                          ...
                          if (message.type == 'CHECKLIST') {
                            try {
                              ...
                              final checklist =
                                  ChecklistMessageModel.fromJson(jsonData);
                              return Row(
                                children: [
                              ...
                              return Row(
                                children: [
                                  ...
                                  const Icon(Icons.checklist,
                                      color: Colors.green, size: 20),
                                  const SizedBox(width: 8),
                                  MixedText('checklist_message'.tr,
                                      style: const TextStyle(
                                          fontSize: 14, color: Colors.black87)),
                                ],
                              );
...
class GroupActionsBottomSheetContent extends StatelessWidget {
  ...
  final Widget Function(
      ...
      required IconData icon,
      required Color iconColor}) buildSettingToggle;
  final Widget Function(
      {required String title,
      required String subtitle,
      required IconData icon,
      required VoidCallback onTap}) buildDangerButton;
              ...
              children: [
                ...
                if (!isAdmin)
                  buildDangerButton(
                    ...
                    onTap: () {
                      groupController
                          .leaveGroup(groupController.groupById.value.id);
                    },
                  ),
                  ...
                  buildDangerButton(
                    ...
                    onTap: () async {
                      ...
                      await groupController
                          .deleteGroup(groupController.groupById.value.id);
                    },
                  ),
            ...
            Flexible(
              child: ListView.separated(
                ...
                itemBuilder: (context, idx) {
                  ...
                  final pinnedAtStr =
                      formatTimestamp(pinMessage.pinnedAt.toString());
                  final bool isSentByMe = pinMessage.message.senderId ==
                      authController.user.value.id;
                  return Material(
                    color: Colors.transparent,
                    child: Column(
                        ...
                        LayoutBuilder(
                          builder: (context, constraints) {
                            ...
                            return Obx(() {
                              ...
                              final latestMessage = groupController
                                      .groupMessages
                                      .firstWhereOrNull(
                                    (msg) => msg.id == pinMessage.message.id,
                                  ) ??
                                  pinMessage.message;
                                ...
                                child: isSentByMe
                                    ? GroupMessageItem(
                                        ...
                                        onReplyTap: (repliedToMessageId) {
                                          ...
                                          final repliedToIndex = groupController
                                              .groupMessages
                                              .indexWhere((msg) =>
  ...
  Widget build(BuildContext context) {
    ...
    return RepaintBoundary(
      child: Obx(() {
        ...
        final isSelected =
            selectedMessages.any((m) => m.id == widget.message.id);
...
class _StableMessageListState extends State<_StableMessageList>
  ...
  void _updateMessages() {
    ...
    final currentMessages = isSearching
    ...
    final String newKey = currentMessages.isEmpty
        ? 'empty'
                ...
                Expanded(
                  ...
                  child: _GroupSelectionAreaWrapper(
                    child: ListView.builder(
                      key: ValueKey(
                          'message_list_$_messagesKey'), // Stable key based on messages
                      reverse: true,
...
class _StableMessageListWidgetState extends State<_StableMessageListWidget>
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      ...
      final RxList<MessageModel> source = groupController.isSearching.value
          ? groupController.searchResults
          : groupController.groupMessages;
      ...
      return _GroupSelectionAreaWrapper(
        child: ListView.builder(
          ...
          reverse: !groupController.isSearching.value ||
          ...
          itemBuilder: (context, index) {
            ...
            final latestMessage = (groupController.isSearching.value
                        ? groupController.searchResults
                        : groupController.groupMessages)
                    .firstWhereOrNull((m) => m.id == messageId) ??
                messages[index];
            ...
            final showDateDivider = index < messages.length - 1
                ? () {
                    ...
                    final nextMessage = (groupController.isSearching.value
                                ? groupController.searchResults
                                : groupController.groupMessages)
            ...
            final isSelected = chatController.selectedMessages
                .any((m) => m.id == latestMessage.id);
            ...
            return Column(
              ...
              children: [
                ...
                GroupMessageItem(
                  key: ValueKey(
                      'group_message_${latestMessage.id}'), // Stable key - status handled internally
                  message:
...
class _GroupMessageInputWrapperState extends State<_GroupMessageInputWrapper>
  ...
  Widget build(BuildContext context) {
    ...
    final messageInput = chatId.isNotEmpty
        ? RepaintBoundary(
    ...
    return Obx(() {
      ...
      if (chatController.isSelectionMode.value) {
        return widget.buildSelectionActions(
            context, List<MessageModel>.from(groupController.groupMessages));
      }
